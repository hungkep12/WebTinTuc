					...
					<div class="col-md-6">
						<div class="post post-thumb">
							<a class="post-img" href="/blog-post/${post.id}-${post.title}"><img
								src="${pageContext.request.contextPath}/img/${post.image}" width="250px" height="300px"
								alt=""></a>
							<div class="post-body">
								<div class="post-meta">
									...
									<span class="post-date"><fmt:formatDate
											value="${post.createdDate}" pattern="dd/MM/yyyy" /></span></span>
								</div>
								<h3 class="post-title">
			...
			<div class="row">
				...
				<c:forEach var="post" items="${post}">
					...
					<div class="col-md-4">
						<div class="post">
							<a class="post-img" href="/blog-post/${post.id}-${post.title}"><img
								src="${pageContext.request.contextPath}/img/${post.image}" width="150px" height="200px"
								alt=""></a>
							<div class="post-body">
								<div class="post-meta">
									<a class="post-category cat-${post.category.id}"
										href="/category/${post.category.name}">${post.category.name}</a>
									<span class="post-date"> <fmt:formatDate
											value="${post.createdDate}" pattern="dd/MM/yyyy" /></span>
								</div>
								<h3 class="post-title">
									<a href="/blog-post/${post.id}-${post.title}" style="width:150px; height:30px;">${post.title}</a>
								</h3>
							</div>
						</div>
					</div>
						...
						<c:forEach var="mostPost" items="${mostPost}" begin="0" end="3">
							...
							<div class="col-md-12">
								<div class="post post-row">
									<a class="post-img"
										href="/blog-post/${mostPost.id}-${mostPost.title}"><img
										src="${pageContext.request.contextPath}/img/${mostPost.image}" width="150px" height="200px"
										alt=""></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-${mostPost.category.id}"
												href="/category/${mostPost.category.name}">${mostPost.category.name}</a>
											<span class="post-date"><fmt:formatDate value="${mostPost.createdDate}" pattern="dd/MM/yyyy"/></span>
										</div>
										<h3 class="post-title">
