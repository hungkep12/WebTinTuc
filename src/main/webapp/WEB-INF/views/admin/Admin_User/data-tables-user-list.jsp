...
<body>
			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="page-header">
						<h2 class="pageheader-title">Danh sách User</h2>
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table id="example"
									...
									<tr>
											<td><img id="image" src="${pageContext.request.contextPath}/img/${user.image}" alt="lỗi hiển thị" width="100px"></td>
											<td>${user.email}</td>
											<td>${user.userName}</td>
											<c:if test="${user.stt == true}">
											<td><span class="badge-dot badge-success mr-1"></span>Online</td>
											</c:if>
											<c:if test="${user.stt == false}">
											<td><span class="badge-dot badge-secondary mr-1"></span>Offline</td>
											</c:if>
											<td>
												<div class="btn-group ml-auto">
													<a href="/admin/edit_user"><button
															class="btn btn-sm btn-outline-light">Edit</button></a> <a
														href="/admin/delete-user/${user.id}"><button class="btn btn-sm btn-outline-light"
															onclick="return window.confirm('Bạn có chắc chắn muốn xoá');" title="Xoá tài khoản">
	...
	<script
		src="https://cdnjs.cloudflttons.html5.min.js"></script>
	<script src="are.com/ajax/libs/jszip/3.1.3/jszip.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/pdfmake.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/vfs_fonts.js"></script>
	<script
		src="https://cdn.datatables.net/buttons/1.5.2/js/bu
