...
<body>
				...
				<div class="row" style="padding-left: 15px">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-inline-block">
									<h5 class="text-muted">Số bài viết</h5>
									<h2 class="mb-0">${countPost}</h2>
								</div>
								<div
									class="float-right icon-circle-medium  icon-box-lg  bg-info-light mt-1">
									<i class="far fa-newspaper fa-fw fa-sm text-info"></i>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-inline-block">
									...
									<h2 class="mb-0">${countUserAccount}</h2>
								</div>
								<div
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
						<div class="card">
							<div class="card-body">
								<div class="d-inline-block">
									<h5 class="text-muted">Người quản lý</h5>
									<h2 class="mb-0">${countAdminAccount}</h2>
								</div>
								<div
									class="float-right icon-circle-medium  icon-box-lg  bg-primary-light mt-1">
									<i class="fas fa-key fa-fw fa-sm text-danger" ></i>
								</div>
							</div>
						</div>
					</div>
									...
									<tbody>
										<c:forEach var="admin" items="${admin}">
											<tr>
												...
												<td>
													<div class="m-r-10">
														<img src="${pageContext.request.contextPath}/img/${admin.image}" alt="user"
												...
												<c:if test="${admin.stt == true }">
													<td><span class="badge-dot badge-success mr-1"></span>Online
													</td>
												</c:if>
												<c:if test="${admin.stt == false }">
													<td><span class="badge-dot badge-secondary mr-1"></span>Offline
													</td>
												</c:if>
											</tr>
										</c:forEach>
										<tr>
											<td colspan="9"><a href="/admin/data-tables-admin-list"
												class="btn btn-outline-light float-right">Chi tiết</a></td>
										</tr>
									</tbody>
								</table>
							</div>
	...
	<!-- sparkline js -->
	<script
		src="${pageContext.request.contextPath}/assets/vendor/charts/sparkline/jquery.sparkline.js"></script>
	<!-- morris js -->
	<script
	...
	<!-- chart c3 js -->
	<script
		src="${pageContext.request.contextPath}/assets/vendor/charts/c3charts/c3.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/vendor/charts/c3charts/d3-5.4.0.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/vendor/charts/c3charts/C3chartjs.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/libs/js/dashboard-ecommerce.js"></script>
</body>
